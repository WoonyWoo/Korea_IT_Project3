...
<head>
  <meta charset="utf-8" />
  <link rel="icon" type="image/png" href="/resources/client/assets2/img/favicon.ico">
...
<div class="wrapper">
  ...
  <a href="http://creative-tim.com">
    <div class="logo-container">
      <div class="logo">
        <img src="/resources/client/assets2/img/new_logo.png">
      </div>
      <div class="brand">
        Creative Tim
      </div>
    ...
    <ul class="dropdown-menu">
      ...
      <li class="active">
        <a class="img-holder" href="compact-table.html">
          <img src="/resources/client/assets2/img/compact.jpg">
          <h5>Compact Table</h5>
        </a>
      </li>
      <li>
        <a class="img-holder" href="full-screen-table.html">
          <img src="/resources/client/assets2/img/full.jpg">
